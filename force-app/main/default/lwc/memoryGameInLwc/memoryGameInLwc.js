...
export default class MemoryGameInLwc extends LightningElement {
    ...
    timer(){
        ...
        this.timerRef = setInterval(()=>{
            ...
            const sDisplay = s>0?m+(s===1?"Second, ":"Seconds, "):""
    ...
    renderedCallback(){
        if(this.isLibLoaded)
        {
            ...
            loadStyle(this, fontawesome+'/font-awesome-4.7.0/css/font-awesome.min.css').then(()=>{
                console.log("CSS Resource Added Successfully")
            }).catch(error=>{
                console.log(error)
            })
